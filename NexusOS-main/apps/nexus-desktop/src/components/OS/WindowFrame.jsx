            ...
            <div dir={isRtl ? 'rtl' : 'ltr'} className="flex flex-col w-full h-full relative">
                ...
                <div className="flex-1 bg-black/40 relative overflow-hidden">
                    ...
                    {app.id === 'cortex' ? (
                        ...
                        <NetGuardModal isOpen={true} onClose={() => closeApp(app.id)} />
                    ) : app.id === 'vault' ? (
                        <SecureVault />
                    ) : app.id === 'settings' ? (
                        <Settings />
                        ...
                        <FileExplorer initialPath={app.context?.initialPath} />
                    ) : app.id === 'ai-control' ? (
                        <NexusAiControl />
                    ) : app.id === 'sentinel-viewer' ? (
                        <EventViewerApp />
                    ) : app.id === 'neural-hub' ? (
                        <NeuralHubApp />
                    ) : app.id === 'aura' ? (
