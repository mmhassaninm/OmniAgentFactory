...
setlocal
echo ========================================================
echo nexusOS [DESKTOP] - DEEP CLEAN INITIALIZATION
echo ========================================================
echo.
...
echo [*] Environment Cleaned. Starting Native Edge...
set NEXUS_BRIDGE=true
echo.

:: Start Vite Server in the background since Electron runs in Dev Mode
start "NexusOS Vite" cmd /c "npx pnpm --filter @nexus/desktop run dev"
